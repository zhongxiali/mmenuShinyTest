(function( $ ) {
  ...
  $(function() {
    ...
    $('body').on('click', 'a', function(ev){
      ...
      var curLoc = location.origin + location.pathname;
      if (href.substring(0,ind) != curLoc){
        // Must be an external link -- don't manipulate.
        return;
      }
    ...
    if (typeof(Shiny) != "undefined") {
      (function() {
        ...
        function onLoggedIn(credentials) {
          ...
          str = '<div class="shiny-server-account">' +
        ...
        var sockjsUrl = loc + "/__sockjs__/n=" + robustId + "/t=" + token + '/w=' + worker  + 
          '/s=' + (isSubApp()? '1':'0')
